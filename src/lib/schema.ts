...
export const surveys = sqliteTable("sessions", {
  ...
  introAudioFilenameEs: text("intro_audio_filename_es"),
  introAudioFilenameCa: text("intro_audio_filename_ca"),
  outroAudioFilename: text("outro_audio_filename"),
  outroAudioFilenameEs: text("outro_audio_filename_es"),
  outroAudioFilenameCa: text("outro_audio_filename_ca"),
  ...
  introHeadingEs: text("intro_heading_es"),
  introHeadingCa: text("intro_heading_ca"),
  introBodyEs: text("intro_body_es"),
  introBodyCa: text("intro_body_ca"),
  outroHeadingEs: text("outro_heading_es"),
  outroHeadingCa: text("outro_heading_ca"),
  outroBodyEs: text("outro_body_es"),
  outroBodyCa: text("outro_body_ca"),
