...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "done.betaOfferMessage": "To say thanks for your time, we'll reserve one of the very first dormies for you! Survey participants get to buy one for just {price}!",
  ...
  es: {
    ...
    "done.betaOfferMessage": "Para agradecerte tu tiempo, ¡te reservaremos uno de los primeros dormies! ¡Los participantes pueden comprar uno por solo {price}!",
  ...
  ca: {
    ...
    "done.betaOfferMessage": "Per agrair-te el teu temps, et reservarem un dels primers dormies! Els participants poden comprar-ne un per només {price}!",
