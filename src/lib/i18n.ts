...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "done.ctaPreorder": "Buy your own highly discounted Dormy (pre-order)",
    "done.ctaPreorderDesc": "Survey participants get to buy one for just {price}!",
    "done.ctaPreorderSuccess": "Pre-order confirmed! We'll be in touch.",
    "done.ctaShare": "Send this survey to your friends!",
  ...
  es: {
    ...
    "done.ctaPreorder": "Compra tu Dormy con descuento (pre-pedido)",
    "done.ctaPreorderDesc": "¡Los participantes pueden comprar uno por solo {price}!",
    "done.ctaPreorderSuccess": "¡Pre-pedido confirmado! Nos pondremos en contacto.",
    "done.ctaShare": "¡Envía esta encuesta a tus amigos!",
  ...
  ca: {
    ...
    "done.ctaPreorder": "Compra el teu Dormy amb descompte (pre-comanda)",
    "done.ctaPreorderDesc": "Els participants poden comprar-ne un per només {price}!",
    "done.ctaPreorderSuccess": "Pre-comanda confirmada! Ens posarem en contacte.",
    "done.ctaShare": "Envia aquesta enquesta als teus amics!",
