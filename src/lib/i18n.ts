...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "intro.audioYes": "Yes",
    "intro.audioNo": "No",
    "intro.ndaConsent": "By pressing START below you agree to our {ndaLink} — you'll keep this product secret!",
    "intro.ndaLinkText": "NDA",
    ...
    "done.modalTitle": "Want a Dormy?!",
    "done.emailForDiscount": "Enter your email for your 50% discount!",
    "done.getDiscount": "Give me my Dormy!",
    ...
    "done.ctaPreorder": "Get your very own Dormy NOW! Exclusive price — {price}",
    "done.ctaPreorderDesc": "Only for you — super discount coupon for the Dormy store!",
    "done.ctaPreorderSuccess": "Pre-order confirmed! We'll be in touch.",
    "done.couponTitle": "Your exclusive discount!",
    "done.couponCopied": "Copied!",
    "done.couponGoToShop": "Go to the shop",
    ...
    "done.shareCopyLink": "Copy link - send this survey to a friend!",
  ...
  es: {
    ...
    "intro.audioYes": "Sí",
    "intro.audioNo": "No",
    "intro.ndaConsent": "Al pulsar COMENZAR aceptas nuestro {ndaLink} — ¡mantendrás este producto en secreto!",
    "intro.ndaLinkText": "NDA",
    ...
    "done.modalTitle": "¡Quieres un Dormy?!",
    "done.emailForDiscount": "¡Introduce tu email para tu 50% de descuento!",
    "done.getDiscount": "¡Dame mi Dormy!",
    ...
    "done.ctaPreorder": "¡Consigue tu propio Dormy AHORA! Precio exclusivo — {price}",
    "done.ctaPreorderDesc": "¡Solo para ti — cupón super descuento para la tienda Dormy!",
    "done.ctaPreorderSuccess": "¡Pre-pedido confirmado! Nos pondremos en contacto.",
    "done.couponTitle": "¡Tu descuento exclusivo!",
    "done.couponCopied": "¡Copiado!",
    "done.couponGoToShop": "Ir a la tienda",
    ...
    "done.shareCopyLink": "Copiar enlace - envia esta encuesta a un amigo!",
  ...
  ca: {
    ...
    "intro.audioYes": "Sí",
    "intro.audioNo": "No",
    "intro.ndaConsent": "En prémer COMENÇAR acceptes el nostre {ndaLink} — mantindràs aquest producte en secret!",
    "intro.ndaLinkText": "NDA",
    ...
    "done.doneButton": "Fet",
    "done.modalTitle": "Vols un Dormy?!",
    "done.emailForDiscount": "Introdueix el teu email pel teu 50% de descompte!",
    "done.getDiscount": "Dona'm el meu Dormy!",
    ...
    "done.ctaPreorder": "Aconsegueix el teu propi Dormy ARA! Preu exclusiu — {price}",
    "done.ctaPreorderDesc": "Només per a tu — cupó super descompte per a la botiga Dormy!",
    "done.ctaPreorderSuccess": "Pre-comanda confirmada! Ens posarem en contacte.",
    "done.couponTitle": "El teu descompte exclusiu!",
    "done.couponCopied": "Copiat!",
    "done.couponGoToShop": "Anar a la botiga",
    ...
    "done.shareCopyLink": "Copiar enllac - envia aquesta enquesta a un amic!",
