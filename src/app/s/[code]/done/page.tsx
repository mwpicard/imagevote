...
export default function DonePage() {
  ...
  const [sharePopupDismissed, setSharePopupDismissed] = useState(false);
  ...
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-white px-6 dark:bg-zinc-950">
      ...
      {/* Share popup — shown after order submit + beta offer dismissed */}
      {(() => {
        const betaGate = !survey.betaPrice || betaOfferDismissed;
        const orderGate = !favouritesLoaded || displayImages.length === 0 || orderSubmitted;
        const showShare = betaGate && orderGate && !sharePopupDismissed;
            ...
            <div className="w-full max-w-sm rounded-2xl bg-white p-8 text-center shadow-2xl dark:bg-zinc-900">
              ...
              <div className="mt-8 flex flex-col gap-3">
                <a
                  ...
                  onClick={() => setSharePopupDismissed(true)}
                  className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#25D366] text-base font-semibold text-white transition-colors hover:bg-[#20bd5a] active:bg-[#1da851]"
                >
                ...
                <button
                  ...
                  className="flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-zinc-200 text-base font-semibold text-zinc-700 transition-colors hover:bg-zinc-50 active:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800"
                >
                  {linkCopied ? (
                    <>
                ...
                <button
                  onClick={() => setSharePopupDismissed(true)}
                  className="mt-1 text-sm font-medium text-zinc-400 transition-colors hover:text-zinc-600 dark:text-zinc-500 dark:hover:text-zinc-300"
                >
                  {t(lang, "done.shareDismiss")}
                </button>
              </div>
            </div>
          </div>
